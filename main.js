...
/**
 * Real Estate Investment Intelligence Scraper
...
Actor.main(async () => {
    console.log('🚀 Starting Real Estate Investment Intelligence Scraper');
    ...
    const finalReport = {
        ...
        scraperInfo: {
            name: 'Real Estate Investment Intelligence Scraper',
            version: '2.0.0',
